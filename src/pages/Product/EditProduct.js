...
class ProductEditPage extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.mode === 'edit') {
      axios
        .get('https://nodejsf.oa.r.appspot.com/products/' + this.props.match.params.id)
  ...
  editProductHandler = event => {
    ...
    if (this.props.match.params.mode === 'edit') {
      request = axios.patch(
        'https://nodejsf.oa.r.appspot.com/products/' + this.props.match.params.id,
        productData
      );
    } else {
      request = axios.post('https://nodejsf.oa.r.appspot.com/products', productData);
    }
    request
      .then(result => {
        this.setState({ isLoading: false });
